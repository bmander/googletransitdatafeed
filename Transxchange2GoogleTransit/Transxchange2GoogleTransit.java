    ...
    throws SAXException, IOException, ParserConfigurationException
    {
        ...
        try {
        	...
        	for (int i = 0; i < handler.getAgencies().getListAgency__agency_name().size(); i++) {
        		out.print(((ValueList)handler.getAgencies().getListAgency__agency_name().get(i)).getValue(0));
        		out.print(",");
        		out.print(((ValueList)handler.getAgencies().getListAgency__agency_url().get(i)).getValue(0));
        		out.print(",");
        		out.println(((ValueList)handler.getAgencies().getListAgency__agency_timezone().get(i)).getValue(0));
...
*/
        ...
        try {
        	...
        	for (int i = 0; i < handler.getStops().getListStops__stop_id().size(); i++) {
        		out.print(((ValueList)handler.getStops().getListStops__stop_id().get(i)).getValue(0));
        		out.print(",");
        		out.print(((ValueList)handler.getStops().getListStops__stop_name().get(i)).getValue(0));
        		out.print(",");
        		out.print(((ValueList)handler.getStops().getListStops__stop_desc().get(i)).getValue(0));
        		out.print(",");
        		out.print(((ValueList)handler.getStops().getListStops__stop_lat().get(i)).getValue(0));
        		out.print(",");
        		out.print(((ValueList)handler.getStops().getListStops__stop_lon().get(i)).getValue(0));
        		out.print(",");
        		out.print(((ValueList)handler.getStops().getListStops__stop_street().get(i)).getValue(0));
        		out.print(",");
        		out.print(((ValueList)handler.getStops().getListStops__stop_city().get(i)).getValue(0));
        		out.print(",");
        		out.print(((ValueList)handler.getStops().getListStops__stop_postcode().get(i)).getValue(0));
        		out.print(",");
        		out.print(((ValueList)handler.getStops().getListStops__stop_region().get(i)).getValue(0));
        		out.print(",");
        		out.println(((ValueList)handler.getStops().getListStops__stop_country().get(i)).getValue(0));
 ...
 */
        ...
        try {
        	...
        	for (int i = 0; i < handler.getRoutes().getListRoutes__route_id().size(); i++) {
        		out.print(((ValueList)handler.getRoutes().getListRoutes__route_id().get(i)).getValue(0));
        		out.print(",");
        		out.print(((ValueList)handler.getRoutes().getListRoutes__route_short_name().get(i)).getValue(0));
        		out.print(",");
        		out.print(((ValueList)handler.getRoutes().getListRoutes__route_long_name().get(i)).getValue(0));
        		out.print(",");
        		out.print(((ValueList)handler.getRoutes().getListRoutes__route_desc().get(i)).getValue(0));
        		out.print(",");
        		out.println(((ValueList)handler.getRoutes().getListRoutes__route_type().get(i)).getValue(0));     
...
*/
        ...
        try {
        	...
        	for (int i = 0; i < handler.getTrips().getListTrips__route_id().size(); i++) {
        		out.print(((ValueList)handler.getTrips().getListTrips__route_id().get(i)).getValue(0));
        		out.print(",");
        		out.print(((ValueList)handler.getTrips().getListTrips__service_id().get(i)).getValue(0));
        		out.print(",");
        		out.print(((ValueList)handler.getTrips().getListTrips__trip_id().get(i)).getKeyName());
        		out.print(",");
        		out.print(((ValueList)handler.getTrips().getListTrips__trip_headsign().get(i)).getValue(0));
        		out.print(",");
        		out.println(((ValueList)handler.getTrips().getListTrips__block_id().get(i)).getValue(0));
/* Java 1.5        		out.printf("%s,%s,%s,%s,%s", 
...
*/
        ...
        try {
        	...
        	for (int i = 0; i < handler.getStopTimes().getListStoptimes__trip_id().size(); i++) {
        		out.print(((ValueList)handler.getStopTimes().getListStoptimes__trip_id().get(i)).getKeyName());
        		out.print(",");
        		out.print(((ValueList)handler.getStopTimes().getListStoptimes__arrival_time().get(i)).getValue(0));
        		out.print(",");
        		out.print(((ValueList)handler.getStopTimes().getListStoptimes__departure_time().get(i)).getValue(0));
        		out.print(",");
        		out.print(((ValueList)handler.getStopTimes().getListStoptimes__stop_id().get(i)).getValue(0));
        		out.print(",");
        		out.print(((ValueList)handler.getStopTimes().getListStoptimes__stop_sequence().get(i)).getValue(0));
        		out.print(",");
        		out.print(((ValueList)handler.getStopTimes().getListStoptimes__pickup_type().get(i)).getValue(0));
        		out.print(",");
        		out.println(((ValueList)handler.getStopTimes().getListStoptimes__drop_off_type().get(i)).getValue(0));
...
*/
        ...
        try {
        	...
        	for (int i = 0; i < handler.getCalendar().getListCalendar__service_id().size(); i++) {
        		out.print(((ValueList)handler.getCalendar().getListCalendar__service_id().get(i)).getValue(0));
        		out.print(",");
        		out.print(((ValueList)handler.getCalendar().getListCalendar__monday().get(i)).getValue(0));
        		out.print(",");
        		out.print(((ValueList)handler.getCalendar().getListCalendar__tuesday().get(i)).getValue(0));
        		out.print(",");
        		out.print(((ValueList)handler.getCalendar().getListCalendar__wednesday().get(i)).getValue(0));
        		out.print(",");
        		out.print(((ValueList)handler.getCalendar().getListCalendar__thursday().get(i)).getValue(0));
        		out.print(",");
        		out.print(((ValueList)handler.getCalendar().getListCalendar__friday().get(i)).getValue(0));
        		out.print(",");
        		out.print(((ValueList)handler.getCalendar().getListCalendar__saturday().get(i)).getValue(0));
        		out.print(",");
        		out.print(((ValueList)handler.getCalendar().getListCalendar__sunday().get(i)).getValue(0));
        		out.print(",");
        		out.print(((ValueList)handler.getCalendar().getListCalendar__start_date().get(i)).getValue(0));
        		out.print(",");
        		out.println(((ValueList)handler.getCalendar().getListCalendar__end_date().get(i)).getValue(0));           			
...
*/
        ...
        try {
        	...
        	for (int i = 0; i < handler.getCalendarDates().getListCalendarDates__service_id().size(); i++) {
        		out.print(((ValueList)handler.getCalendarDates().getListCalendarDates__service_id().get(i)).getValue(0));
        		out.print(",");
        		out.print(((ValueList)handler.getCalendarDates().getListCalendarDates__date().get(i)).getValue(0));
        		out.print(",");
        		out.println(((ValueList)handler.getCalendarDates().getListCalendarDates__exception_type().get(i)).getValue(0));           			
/* Java 1.5        		out.printf("%s,%s,%s", 
